...
sensors:bytes-sensors.o forward-facing-radar.o park-assist.o \
		surround-view-cameras.o windshield-camera.o \
		service-functions.o
	ar rs $(EXECUTABLE)sensors $(EXECUTABLE)bytes-sensors.o \
	$(EXECUTABLE)forward-facing-radar.o $(EXECUTABLE)park-assist.o \
