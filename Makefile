...
exec: sensors actuators central-ECU.o hmi service-functions.o
	cc -o $(EXECUTABLE)exec $(EXECUTABLE)central-ECU.o $(EXECUTABLE)sensors $(EXECUTABLE)actuators $(EXECUTABLE)hmi $(EXECUTABLE)service-functions.o 


##########################
sensors: bytes-sensors.o forward-facing-radar.o park-assist.o surround-view-cameras.o windshield-camera.o $(HEADERS)service-functions.h
	ar rs $(EXECUTABLE)sensors $(EXECUTABLE)bytes-sensors.o $(EXECUTABLE)forward-facing-radar.o $(EXECUTABLE)park-assist.o $(EXECUTABLE)surround-view-cameras.o $(EXECUTABLE)windshield-camera.o
...
surround-view-cameras.o:service-functions.o
	cc -c -o$(EXECUTABLE)surround-view-cameras.o $(SRC_SEN_DIR)surround-view-cameras.c
...
actuators: brake-by-wire.o steer-by-wire.o throttle-control.o
	ar rs $(EXECUTABLE)actuators $(EXECUTABLE)brake-by-wire.o $(EXECUTABLE)steer-by-wire.o $(EXECUTABLE)throttle-control.o
...
hmi: hmi-output.o hmi-input.o
	ar rs $(EXECUTABLE)hmi $(EXECUTABLE)hmi-output.o $(EXECUTABLE)hmi-input.o
