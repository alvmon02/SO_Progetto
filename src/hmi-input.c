...
int main() {
	...
	/* Imposta la gestione dei vari segnali:
	 *	SIGUSR2 -> immissione di input non valido
	 *	SIGUSR1 -> fallimento nell'accelerazione
	 */
	...
	// dello stdin (fgets) e una volta ottenuta la controlla per
